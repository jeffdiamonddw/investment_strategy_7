...
if __name__ == "__main__":
    ...
    problem_args['holdings_folder'] = "{}/holdings/".format(problem_args['output_folder'])
    problem_args['eval_folder'] = "{}/evaluations/".format(problem_args['output_folder'])
    del problem_args['output_folder']
    problem_args['objective_functions_dict'] = objective_functions_dict
    problem_args['objective_sense'] = objective_sense
    
    
    problem = RegimeNavigator1D(**problem_args)    # The 'Wrapped' class + Sim Args
